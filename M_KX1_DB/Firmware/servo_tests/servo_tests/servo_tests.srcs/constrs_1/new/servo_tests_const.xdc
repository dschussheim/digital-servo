...
#set_property PACKAGE_PIN L17 [get_ports c_out[1]]
#set_property IOSTANDARD LVCMOS25 [get_ports c_out[1]]
#set_property PACKAGE_PIN K18 [get_ports c_out[0]]
#set_property IOSTANDARD LVCMOS25 [get_ports c_out[0]]
