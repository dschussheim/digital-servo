...
HD_PWD='C:/Users/dschussheim/Documents/GitHub/digital-servo/M_KX1_DB/Firmware/led_test_KX2/led_test_KX2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log light_leds.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source light_leds.tcl
