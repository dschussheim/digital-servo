...
set_property IOSTANDARD  LVCMOS15 [get_ports locked_out]
set_property PACKAGE_PIN L17      [get_ports notlocked_out]
set_property IOSTANDARD  LVCMOS15 [get_ports notlocked_out]
set_property PACKAGE_PIN K18      [get_ports notlocked1s_out]
set_property IOSTANDARD  LVCMOS15 [get_ports notlocked1s_out]
