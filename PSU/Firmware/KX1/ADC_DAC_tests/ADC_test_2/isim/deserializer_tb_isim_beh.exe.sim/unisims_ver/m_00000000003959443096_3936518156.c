...
LAB5:    t5 = (t1 + 3704);
    ...
    t7 = *((char **)t4);
    t4 = (t1 + 3704);
    xsi_vlogfile_write(1, 0, 0, ng1, 4, t4, (char)118, t5, 80, (char)118, t6, 24, (char)119, t7, 32);
    t4 = (t1 + 3704);
...
LAB55:    t2 = ((char*)((ng26)));
    t4 = xsi_vlog_unsigned_case_compare(t10, 32, t2, 32);
    if (t4 == 1)
        goto LAB56;

LAB57:    t12 = ((char*)((ng27)));
    t6 = xsi_vlog_unsigned_case_compare(t10, 32, t12, 32);
    if (t6 == 1)
        goto LAB58;

LAB59:    t14 = ((char*)((ng28)));
    t9 = xsi_vlog_unsigned_case_compare(t10, 32, t14, 32);
    if (t9 == 1)
        goto LAB60;

LAB61:    t16 = ((char*)((ng29)));
    t11 = xsi_vlog_unsigned_case_compare(t10, 32, t16, 32);
    if (t11 == 1)
        goto LAB62;
...
LAB67:    t18 = (t0 + 1696);
    t20 = *((char **)t18);
    xsi_vlogfile_write(1, 0, 0, ng30, 2, t0, (char)118, t20, 32);
    xsi_vlog_finish(1);
...
LAB86:    t2 = ((char*)((ng34)));
    t4 = xsi_vlog_unsigned_case_compare(t16, 80, t2, 88);
    if (t4 == 1)
        goto LAB87;
...
LAB92:    t18 = ((char*)((ng37)));
    t6 = xsi_vlog_unsigned_case_compare(t16, 80, t18, 88);
    if (t6 == 1)
        goto LAB93;

LAB94:    t26 = ((char*)((ng38)));
    t9 = xsi_vlog_unsigned_case_compare(t16, 80, t26, 88);
    if (t9 == 1)
        goto LAB95;
...
LAB205:    t2 = (t0 + 1560);
    t18 = *((char **)t2);
    xsi_vlogfile_write(1, 0, 0, ng39, 2, t0, (char)118, t18, 80);
    xsi_vlog_finish(1);
...
LAB116:;
LAB118:    t27 = (t0 + 25440U);
    *((char **)t27) = &&LAB115;
    goto LAB1;

LAB122:;
LAB124:    t24 = (t0 + 25440U);
    *((char **)t24) = &&LAB121;
    goto LAB1;
...
LAB22:    t2 = (t0 + 1696);
    t3 = *((char **)t2);
    xsi_vlogfile_write(1, 0, 0, ng30, 2, t0, (char)118, t3, 32);
    xsi_vlog_finish(1);
...
extern void unisims_ver_m_00000000003959443096_3936518156_init()
{
	...
	xsi_register_didat("unisims_ver_m_00000000003959443096_3936518156", "isim/deserializer_tb_isim_beh.exe.sim/unisims_ver/m_00000000003959443096_3936518156.didat");
