...
HD_PWD='C:/Users/dschussheim/Documents/GitHub/digital-servo/M_KX1_DB/Firmware/led_test_KX2/led_test_KX2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log light_leds.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source light_leds.tcl -notrace
